...
Dans les prochains cours, nous allons réaliser un jeu de type "endless runner" où le joueur contrôle un avion qui doit éviter les obstacles et collecter des étoiles pour marquer des points.
